...
impl Parser {
    ...
    fn yyaction(&mut self, yyn: i32, yystack: &mut YYStack, yylen: &mut usize) -> Result<i32, ()> {
        ...
        match yyn {
            ...
            17 =>
            /* let_stmt: "let" identifier ":" path "=" expr  */
            /* "src/parser.y":132  */
            {
                yyval = Value::StatementLet(
            ...
            /* "src/parser.y":138  */
            {
                yyval = Value::Expr(Box::new(Value::AdditionExpr(
                    Box::new(yystack.owned_value_at(2)),
                    Box::new(yystack.owned_value_at(0)),
                )))
            }
...
impl Parser {
    ...
    const yypact_: &'static [i32] = &[
        -15, -14, 6, -2, -17, -17, 9, -17, -15, -14, -17, -6, -17, 8, 10, -14, -14, -14, -17, -17,
        5, -17, 3, -14, 7, -17, -17, -14, -5, -17, -17, 12, -17, -17, -14, -3, 2, -17, 21, -17, 2,
        -17,
    ];
    ...
    const yydefact_: &'static [i32] = &[
        0, 0, 0, 2, 3, 9, 0, 1, 0, 0, 4, 0, 6, 0, 0, 0, 0, 0, 7, 12, 8, 10, 0, 0, 0, 5, 11, 0, 0,
        14, 16, 0, 13, 15, 0, 0, 0, 20, 17, 18, 0, 19,
    ];

    /* YYPGOTO[NTERM-NUM].  */
    #[allow(non_upper_case_globals)]
    const yypgoto_: &'static [i32] = &[
        -17, -17, -17, 17, -17, 13, -1, -16, 4, -17, -17, 1, -17, -10, -17,
    ];

    /* YYDEFGOTO[NTERM-NUM].  */
    #[allow(non_upper_case_globals)]
    const yydefgoto_: &'static [i32] = &[0, 2, 3, 4, 11, 12, 19, 20, 21, 25, 28, 29, 30, 38, 39];
    ...
    const yytable_: &'static [i32] = &[
        6, 22, 14, 5, 1, 32, 7, 15, 13, 23, 27, 8, 24, 36, 13, 23, 9, 23, 35, 16, 37, 17, 27, 34,
        40, 10, 31, 26, 18, 33, 41,
    ];

    #[allow(non_upper_case_globals)]
    const yycheck_: &'static [i32] = &[
        1, 17, 8, 17, 19, 10, 0, 13, 9, 12, 15, 13, 9, 16, 15, 12, 7, 12, 34, 11, 18, 11, 15, 11,
        3, 8, 27, 23, 15, 28, 40,
    ];
    ...
    const yystos_: &'static [i32] = &[
        0, 19, 24, 25, 26, 17, 29, 0, 13, 7, 26, 27, 28, 29, 8, 13, 11, 11, 28, 29, 30, 31, 30, 12,
        9, 32, 31, 15, 33, 34, 35, 29, 10, 34, 11, 30, 16, 18, 36, 37, 3, 36,
    ];

    /* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
    #[allow(non_upper_case_globals)]
    const yyr1_: &'static [i32] = &[
        0, 23, 24, 25, 25, 26, 27, 27, 28, 29, 30, 30, 31, 32, 33, 33, 34, 35, 36, 36, 37,
    ];

    /* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.  */
    #[allow(non_upper_case_globals)]
    const yyr2_: &'static [i32] = &[
        0, 2, 1, 1, 3, 8, 1, 3, 3, 1, 1, 3, 1, 3, 1, 2, 1, 6, 1, 3, 1,
    ];

    /* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
    #[allow(non_upper_case_globals)]
    const yyrline_: &'static [i32] = &[
        0, 68, 68, 74, 77, 84, 87, 90, 96, 99, 104, 107, 113, 117, 120, 123, 129, 132, 135, 138,
        141,
    ];
