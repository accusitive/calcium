...
impl SymbolKind {
    ...
    const VALUES_: &'static [SymbolKind] = &[ 
        ...
        SymbolKind { value: SymbolKind::S_tRETURN },
        SymbolKind { value: SymbolKind::S_tSTRUCT },
        SymbolKind { value: SymbolKind::S_tIMPORT },
...
const yynames_: &'static [&'static str] = &[ "end of file", "error", "invalid token", "+", "-", "*", "/", "(", ")",
  "{", "}", ":", "::", ",", "let", "=", "return", "struct", "import", "_",
  "local variable or method", "number", "fn", "controlled YYERROR",
  ...
  "path_segment", "block_expr", "statements", "statement", "let_stmt",
  "return_stmt", "ty", "call_params", "none", "expr", "literal_expr",
  "call_expr", "<<NULL>>" ] ;
...
impl Parser {
  ...
  13 =>  /* function: "fn" identifier "(" function_args ")" ":" path block_expr  */
  /* "src/parser.y":125  */
                                                                               {
     yyval = Value::Function( Ident::from(yystack.owned_value_at(6)), Box::new( yystack.owned_value_at(4)), Box::new(Value::Ty(Box::new( yystack.owned_value_at(1)))), Box::new( yystack.owned_value_at(0)));
 },
  ...
  16 =>  /* function_arg: identifier ":" path  */
  /* "src/parser.y":137  */
                                       {
     yyval = Value::FunctionArg( Ident::from(yystack.owned_value_at(2)), Box::new(Value::Ty(Box::new( yystack.owned_value_at(0)))));
 },
  ...
  /* "src/parser.y":160  */
                    {
    yyval = Value::PathExpr(Box::new(Value::ValueList(vec![ yystack.owned_value_at(0)])));
 },
  ...
  28 =>  /* let_stmt: "let" identifier ":" ty "=" expr  */
  /* "src/parser.y":191  */
                                                  {
  ...
  34 =>  /* call_params: call_params "," expr  */
  /* "src/parser.y":209  */
                             {
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yypact_: &'static [i32] = &[      9,   -47,   -16,   -16,   -16,     8,    31,   -47,   -47,   -47,
     -47,   -47,     5,   -47,    16,   -47,   -47,   -16,   -16,    48,
     -47,    19,     4,   -47,    25,   -47,   -47,   -16,    32,    53,
     -16,   -16,   -47,   -47,   -47,    30,   -47,   -47,   -16,   -47,
      30,   -16,    50,   -47,    49,   -47,   -16,    26,    -5,   -47,
     -47,   -47,    57,    26,   -47,    17,   -47,    51,   -47,   -47,
     -47,   -47,    32,    35,    26,    26,    26,    26,    26,    45,
     -47,    37,   -47,    51,    61,    61,   -47,   -47,    26,   -47,
      26,    51,    51 ];
...
const yydefact_: &'static [i32] = &[      0,     3,     0,     0,     0,     0,     2,     4,     6,     7,
       8,    19,     0,    18,     0,     1,     5,     0,    35,     0,
      10,     0,     0,    14,     0,    17,     9,     0,     0,     0,
      35,     0,    11,    31,    22,    30,    20,    12,     0,    15,
      16,     0,     0,    21,     0,    13,     0,     0,     0,    24,
      26,    27,     0,     0,    45,    40,    37,    29,    36,    38,
      23,    25,     0,     0,    35,     0,     0,     0,     0,     0,
      39,     0,    32,    33,    41,    42,    43,    44,     0,    46,
       0,    28,    34 ];

/* YYPGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yypgoto_: &'static [i32] = &[    -47,   -47,   -47,    63,   -47,   -47,    43,   -47,   -47,    41,
     -47,    -2,   -25,    33,    34,   -47,    24,   -47,   -47,    11,
     -47,    13,   -46,   -47,   -47 ];

/* YYDEFGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yydefgoto_: &'static [i32] = &[      0,     5,     6,     7,     8,    19,    20,     9,    22,    23,
      10,    34,    55,    36,    56,    48,    49,    50,    51,    37,
      71,    25,    57,    58,    59 ];
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  #[allow(non_upper_case_globals)]
const yytable_: &'static [i32] = &[     12,    13,    14,    35,    11,    60,    40,    63,    15,    46,
       1,    47,    29,    42,    17,    21,    24,    30,    73,    74,
      75,    76,    77,    18,    64,    21,     2,     3,    24,    41,
      28,     4,    81,    53,    82,    44,    31,    35,    65,    66,
      67,    68,    41,    70,    52,    79,    11,    54,     2,     3,
      80,    33,    11,     4,    65,    66,    67,    68,    26,    44,
      78,    27,    41,    46,    38,    47,    67,    68,    62,    16,
      32,    39,    61,    69,    43,     0,    45,    72 ];

#[allow(non_upper_case_globals)]
const yycheck_: &'static [i32] = &[      2,     3,     4,    28,    20,    10,    31,    53,     0,    14,
       1,    16,     8,    38,     9,    17,    18,    13,    64,    65,
      66,    67,    68,     7,     7,    27,    17,    18,    30,    12,
      11,    22,    78,     7,    80,     9,    11,    62,     3,     4,
       5,     6,    12,     8,    46,     8,    20,    21,    17,    18,
      13,    19,    20,    22,     3,     4,     5,     6,    10,     9,
      15,    13,    12,    14,    11,    16,     5,     6,    11,     6,
      27,    30,    48,    62,    41,    -1,    42,    64 ];

/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yystos_: &'static [i32] = &[      0,     1,    17,    18,    22,    27,    28,    29,    30,    33,
      36,    20,    37,    37,    37,     0,    29,     9,     7,    31,
      32,    37,    34,    35,    37,    47,    10,    13,    11,     8,
      13,    11,    32,    19,    37,    38,    39,    45,    11,    35,
      38,    12,    38,    39,     9,    40,    14,    16,    41,    42,
      43,    44,    37,     7,    21,    38,    40,    48,    49,    50,
      10,    42,    11,    48,     7,     3,     4,     5,     6,    45,
       8,    46,    47,    48,    48,    48,    48,    48,    15,     8,
      13,    48,    48 ];

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
  #[allow(non_upper_case_globals)]
const yyr1_: &'static [i32] = &[      0,    26,    27,    27,    28,    28,    29,    29,    29,    30,
...
/* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
  #[allow(non_upper_case_globals)]
const yyrline_: &'static [i32] = &[      0,    84,    84,    88,    92,    95,   101,   104,   107,   110,
     113,   116,   121,   125,   128,   131,   137,   140,   143,   155,
     160,   163,   169,   173,   176,   179,   185,   188,   191,   194,
     199,   202,   205,   207,   209,   215,   223,   226,   229,   232,
     235,   238,   241,   244,   247,   250,   253 ];
