...
impl Parser {
    ...
    const yypact_: &'static [i32] = &[
        11, -69, -26, -26, -26, 17, 35, -69, -69, -69, -69, -69, 23, -69, 38, -69, -69, -26, -26,
        42, -69, 13, -3, -69, 55, -69, -69, -26, 74, 58, -26, 74, -69, 74, -69, -69, -69, -69, -69,
        -69, -69, 34, -69, -69, 74, -69, -69, -69, -26, 67, -69, 47, -69, 20, -69, -26, -69, 20,
        -26, 74, 15, -69, 88, -69, -69, -69, -69, 112, -69, -69, -69, -69, -69, -69, 102, 70, 112,
        16, -69, 20, -69, 61, 20, 20, 20, 20, -26, -69, 74, 20, 10, -69, 112, -69, 68, 68, 71, 71,
        -69, 65, 39, -69, 20, 20, -69, 112, 112,
    ];
    ...
    const yydefact_: &'static [i32] = &[
        ...
        0, 24, 0, 60, 0, 0, 59, 62, 47, 0, 25, 27, 28, 29, 32, 45, 56, 57, 48, 50, 51, 0, 0, 31, 0,
        58, 44, 23, 0, 0, 0, 0, 0, 0, 49, 0, 44, 0, 41, 42, 26, 52, 53, 54, 55, 63, 0, 0, 61, 0, 0,
        46, 43, 30,
    ];
    ...
    const yypgoto_: &'static [i32] = &[
        -69, -69, -69, 82, -69, -69, 63, -69, -69, 69, -69, -2, -25, 52, 60, -69, 30, -69, -69,
        -69, -24, 12, -68, -43, -69, -69, -69, -69, -69, -69,
    ];

    /* YYDEFGOTO[NTERM-NUM].  */
    #[allow(non_upper_case_globals)]
    const yydefgoto_: &'static [i32] = &[
        0, 5, 6, 7, 8, 19, 20, 9, 22, 23, 10, 40, 60, 42, 61, 62, 63, 64, 65, 66, 43, 90, 25, 67,
        68, 69, 70, 71, 72, 73,
    ];
    ...
    const yytable_: &'static [i32] = &[
        12, 13, 14, 41, 11, 29, 41, 46, 41, 47, 74, 91, 1, 30, 76, 21, 24, 15, 101, 41, 49, 91, 79,
        89, 28, 21, 102, 53, 24, 51, 48, 48, 17, 77, 41, 78, 92, 2, 3, 94, 95, 96, 97, 4, 56, 18,
        92, 104, 58, 48, 11, 59, 26, 75, 53, 102, 51, 54, 27, 105, 106, 2, 3, 41, 99, 55, 31, 4,
        53, 44, 51, 56, 57, 84, 85, 58, 51, 11, 59, 55, 86, 88, 103, 86, 98, 56, 57, 33, 16, 58,
        32, 11, 59, 34, 35, 36, 37, 38, 80, 45, 50, 100, 81, 39, 11, 82, 83, 84, 85, 52, 87, 93, 0,
        0, 86, 82, 83, 84, 85, 0, 0, 0, 0, 0, 86,
    ];

    #[allow(non_upper_case_globals)]
    const yycheck_: &'static [i32] = &[
        2, 3, 4, 28, 30, 8, 31, 31, 33, 33, 53, 79, 1, 16, 57, 17, 18, 0, 8, 44, 44, 89, 7, 7, 11,
        27, 16, 7, 30, 9, 15, 15, 9, 58, 59, 59, 79, 26, 27, 82, 83, 84, 85, 32, 24, 7, 89, 8, 28,
        15, 30, 31, 10, 55, 7, 16, 9, 10, 16, 102, 103, 26, 27, 88, 88, 18, 11, 32, 7, 11, 9, 24,
        25, 5, 6, 28, 9, 30, 31, 18, 12, 11, 17, 12, 86, 24, 25, 13, 6, 28, 27, 30, 31, 19, 20, 21,
        22, 23, 10, 30, 48, 89, 14, 29, 30, 3, 4, 5, 6, 49, 8, 81, -1, -1, 12, 3, 4, 5, 6, -1, -1,
        -1, -1, -1, 12,
    ];
    ...
    const yystos_: &'static [i32] = &[
        0, 1, 26, 27, 32, 37, 38, 39, 40, 43, 46, 30, 47, 47, 47, 0, 39, 9, 7, 41, 42, 47, 44, 45,
        47, 58, 10, 16, 11, 8, 16, 11, 42, 13, 19, 20, 21, 22, 23, 29, 47, 48, 49, 56, 11, 45, 56,
        56, 15, 56, 49, 9, 50, 7, 10, 18, 24, 25, 28, 31, 48, 50, 51, 52, 53, 54, 55, 59, 60, 61,
        62, 63, 64, 65, 59, 47, 59, 48, 56, 7, 10, 14, 3, 4, 5, 6, 12, 8, 11, 7, 57, 58, 59, 52,
        59, 59, 59, 59, 47, 56, 57, 8, 16, 17, 8, 59, 59,
    ];

    /* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
    #[allow(non_upper_case_globals)]
    const yyr1_: &'static [i32] = &[
        0, 36, 37, 37, 38, 38, 39, 39, 39, 40, 41, 41, 42, 43, 44, 44, 45, 45, 46, 47, 48, 48, 49,
        50, 50, 51, 51, 52, 52, 52, 53, 54, 55, 56, 56, 56, 56, 56, 56, 56, 56, 57, 57, 57, 58, 59,
        59, 59, 59, 59, 59, 59, 59, 59, 59, 59, 60, 60, 61, 61, 62, 63, 64, 65,
    ];
    ...
    const yyr2_: &'static [i32] = &[
        ...
        6, 2, 1, 1, 1, 1, 1, 1, 1, 1, 2, 1, 1, 3, 0, 1, 5, 1, 1, 3, 1, 1, 3, 3, 3, 3, 1, 1, 2, 1,
        1, 4, 1, 3,
    ];
    ...
    const yyrline_: &'static [i32] = &[
        0, 103, 103, 107, 111, 114, 120, 123, 126, 129, 132, 135, 140, 144, 147, 150, 156, 159,
        162, 175, 180, 183, 189, 193, 196, 199, 202, 208, 211, 214, 217, 220, 223, 228, 231, 234,
        237, 240, 243, 246, 249, 253, 255, 257, 263, 271, 274, 277, 280, 283, 286, 289, 292, 295,
        298, 301, 305, 308, 311, 314, 317, 320, 323, 326,
    ];
