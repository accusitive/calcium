...
impl Parser {
  ...
  /* "src/parser.y":149  */
                                                                   {
     yyval = Value::ExternFunction( Ident::from(yystack.owned_value_at(5)), Box::new( yystack.owned_value_at(3)), Box::new( yystack.owned_value_at(0)))
 },


  15 =>  /* function_args: function_arg  */
  /* "src/parser.y":152  */
                             {
     yyval = Value::ValueList(vec![ yystack.owned_value_at(0)]);
 },
  ...
  16 =>  /* function_args: function_args "," function_arg  */
  /* "src/parser.y":155  */
                                     {
  ...
  20 =>  /* identifier: "local variable or method"  */
  /* "src/parser.y":180  */
                         {
  ...
  31 =>  /* let_stmt: "let" identifier ":" ty "=" expr  */
  /* "src/parser.y":222  */
                                                  {
  ...
  44 =>  /* call_params: call_params "," expr  */
  /* "src/parser.y":262  */
                             {
  ...
  57 =>  /* literal_expr: integer_literal  */
  /* "src/parser.y":310  */
                               {
  ...
  58 =>  /* literal_expr: string_literal  */
  /* "src/parser.y":313  */
                  {
    yyval = Value::LiteralExpr(Box::new( yystack.owned_value_at(0)))
 },
  ...
  61 =>  /* string_literal: "Text wrapped in quotes"  */
  /* "src/parser.y":322  */
                         {
  ...
  64 =>  /* field_expression: expr "." identifier  */
  /* "src/parser.y":331  */
                                           {
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yypact_: &'static [i32] = &[     26,   -83,   -21,   -21,   -22,   -21,    32,    95,   -83,   -83,
     -83,   -83,   -83,    39,   -83,   -21,    28,   -83,   -83,   -21,
      35,   -21,    18,   -83,    58,   -21,    -4,   -83,    59,   -83,
     -83,   -21,    87,     8,    62,   -21,    87,   -83,    87,   -83,
     -83,   -83,   -83,   -83,   -83,   -83,    43,   -83,   -83,    63,
      87,   -83,   -83,   -83,   -21,    87,    74,   -83,   -83,    47,
     -83,    53,   -83,   -21,   -83,    53,   -21,    87,    15,   -83,
      37,   -83,   -83,   -83,   -83,    83,   -83,   -83,   -83,   -83,
     -83,   -83,   108,    79,    83,    24,   -83,    53,   -83,    73,
      53,    53,    53,    53,   -21,   -83,    87,    53,    33,   -83,
      83,   -83,   120,   120,    81,    81,   -83,    77,    60,   -83,
      53,    53,   -83,    83,    83 ];
...
const yydefact_: &'static [i32] = &[      0,     3,     0,     0,     0,     0,     0,     2,     4,     6,
       7,     8,    20,     0,    19,     0,     0,     1,     5,     0,
       0,    45,     0,    10,     0,    45,     0,    15,     0,    18,
       9,     0,     0,     0,     0,    45,     0,    11,     0,    34,
      35,    36,    37,    38,    40,    23,    39,    21,    12,     0,
       0,    16,    17,    41,     0,     0,     0,    22,    14,     0,
      13,     0,    25,     0,    61,     0,     0,    60,    63,    48,
       0,    26,    28,    29,    30,    33,    46,    57,    58,    49,
      51,    52,     0,     0,    32,     0,    59,    45,    24,     0,
       0,     0,     0,     0,     0,    50,     0,    45,     0,    42,
      43,    27,    53,    54,    55,    56,    64,     0,     0,    62,
       0,     0,    47,    44,    31 ];

/* YYPGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yypgoto_: &'static [i32] = &[    -83,   -83,   -83,    89,   -83,   -83,    68,   -83,    78,    67,
     -83,    -2,   -30,    61,    71,   -83,    30,   -83,   -83,   -83,
     -29,    34,   -82,   -47,   -83,   -83,   -83,   -83,   -83,   -83 ];

/* YYDEFGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yydefgoto_: &'static [i32] = &[      0,     6,     7,     8,     9,    22,    23,    10,    26,    27,
      11,    45,    68,    47,    69,    70,    71,    72,    73,    74,
      48,    98,    29,    75,    76,    77,    78,    79,    80,    81 ];

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
  #[allow(non_upper_case_globals)]
const yytable_: &'static [i32] = &[     13,    14,    46,    16,    34,    99,    46,    52,    46,    53,
      12,    15,    35,    20,    82,    99,    49,    24,    84,    28,
      46,    56,    87,    28,    35,    46,    58,     1,    30,    24,
      54,    97,    17,    28,    31,    21,    85,    46,    86,    54,
     100,   109,    25,   102,   103,   104,   105,    88,    19,   110,
     100,    89,     2,     3,    61,     4,    59,    62,    54,     5,
      61,    83,    59,   113,   114,    63,    46,   107,   112,    32,
      36,    64,    65,    50,    55,    66,   110,    64,    12,    67,
      61,    66,    59,    59,    12,    67,    90,    91,    92,    93,
      96,    63,   106,    94,   111,    94,    18,    64,    65,    37,
      38,    66,    51,    33,    12,    67,    39,    40,    41,    42,
      43,    90,    91,    92,    93,    57,    95,    44,    12,   101,
      94,     2,     3,     0,     4,    92,    93,    60,     5,     0,
       0,   108,    94 ];

#[allow(non_upper_case_globals)]
const yycheck_: &'static [i32] = &[      2,     3,    32,     5,     8,    87,    36,    36,    38,    38,
      31,    33,    16,    15,    61,    97,     8,    19,    65,    21,
      50,    50,     7,    25,    16,    55,    55,     1,    10,    31,
      15,     7,     0,    35,    16,     7,    66,    67,    67,    15,
      87,     8,     7,    90,    91,    92,    93,    10,     9,    16,
      97,    14,    26,    27,     7,    29,     9,    10,    15,    33,
       7,    63,     9,   110,   111,    18,    96,    96,     8,    11,
      11,    24,    25,    11,    11,    28,    16,    24,    31,    32,
       7,    28,     9,     9,    31,    32,     3,     4,     5,     6,
      11,    18,    94,    12,    17,    12,     7,    24,    25,    31,
      13,    28,    35,    25,    31,    32,    19,    20,    21,    22,
      23,     3,     4,     5,     6,    54,     8,    30,    31,    89,
      12,    26,    27,    -1,    29,     5,     6,    56,    33,    -1,
      -1,    97,    12 ];

/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yystos_: &'static [i32] = &[      0,     1,    26,    27,    29,    33,    38,    39,    40,    41,
      44,    47,    31,    48,    48,    33,    48,     0,    40,     9,
      48,     7,    42,    43,    48,     7,    45,    46,    48,    59,
      10,    16,    11,    45,     8,    16,    11,    43,    13,    19,
      20,    21,    22,    23,    30,    48,    49,    50,    57,     8,
      11,    46,    57,    57,    15,    11,    57,    50,    57,     9,
      51,     7,    10,    18,    24,    25,    28,    32,    49,    51,
      52,    53,    54,    55,    56,    60,    61,    62,    63,    64,
      65,    66,    60,    48,    60,    49,    57,     7,    10,    14,
       3,     4,     5,     6,    12,     8,    11,     7,    58,    59,
      60,    53,    60,    60,    60,    60,    48,    57,    58,     8,
      16,    17,     8,    60,    60 ];

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
  #[allow(non_upper_case_globals)]
const yyr1_: &'static [i32] = &[      0,    37,    38,    38,    39,    39,    40,    40,    40,    41,
...
const yyrline_: &'static [i32] = &[      0,   105,   105,   109,   113,   116,   122,   125,   128,   131,
     134,   137,   142,   146,   149,   152,   155,   161,   164,   167,
     180,   185,   188,   194,   198,   201,   204,   207,   213,   216,
     219,   222,   225,   228,   233,   236,   239,   242,   245,   248,
     251,   254,   258,   260,   262,   268,   276,   279,   282,   285,
     288,   291,   294,   297,   300,   303,   306,   310,   313,   316,
     319,   322,   325,   328,   331 ];
