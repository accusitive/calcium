...
impl Parser {
    ...
    fn yyaction(&mut self, yyn: i32, yystack: &mut YYStack, yylen: &mut usize) -> Result<i32, ()> {
        ...
        match yyn {
            ...
            5 =>
            /* function: "fn" identifier "(" function_args ")" ":" path  */
            /* "src/parser.y":75  */
            {
                yyval = Value::Function(
                    Ident::from(yystack.owned_value_at(5)),
                    vec![yystack.owned_value_at(3)],
...
impl Parser {
    ...
    const yypact_: &'static [i32] = &[
        -15, -12, 4, -8, -16, -16, 0, -16, -15, -12, -16, -7, -16, -2, 1, -12, -12, -12, -16, -16,
        3, -16, 3, -12, -16,
    ];
    ...
    const yydefact_: &'static [i32] = &[
        0, 0, 0, 2, 3, 9, 0, 1, 0, 0, 4, 0, 6, 0, 0, 0, 0, 0, 7, 12, 8, 10, 5, 0, 11,
    ];
    ...
    const yytable_: &'static [i32] = &[
        6, 14, 1, 5, 7, 8, 15, 9, 13, 16, 10, 18, 17, 24, 13, 23, 0, 0, 0, 0, 0, 0, 22,
    ];

    #[allow(non_upper_case_globals)]
    const yycheck_: &'static [i32] = &[
        1, 8, 17, 15, 0, 13, 13, 7, 9, 11, 8, 15, 11, 23, 15, 12, -1, -1, -1, -1, -1, -1, 17,
    ];
    ...
    const yystos_: &'static [i32] = &[
        0, 17, 22, 23, 24, 15, 27, 0, 13, 7, 24, 25, 26, 27, 8, 13, 11, 11, 26, 27, 28, 29, 28, 12,
        29,
    ];

    /* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
    #[allow(non_upper_case_globals)]
    const yyr1_: &'static [i32] = &[0, 21, 22, 23, 23, 24, 25, 25, 26, 27, 28, 28, 29];

    /* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.  */
    #[allow(non_upper_case_globals)]
    const yyr2_: &'static [i32] = &[0, 2, 1, 1, 3, 7, 1, 3, 3, 1, 1, 3, 1];

    /* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
    #[allow(non_upper_case_globals)]
    const yyrline_: &'static [i32] = &[0, 59, 59, 65, 68, 75, 78, 81, 87, 90, 94, 97, 103];
