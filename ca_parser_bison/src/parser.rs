...
impl SymbolKind {
    ...
    const VALUES_: &'static [SymbolKind] = &[ 
        ...
        SymbolKind { value: SymbolKind::S_tI128 },
...
const yynames_: &'static [&'static str] = &[ "end of file", "error", "invalid token", "+", "-", "*", "/", "(", ")",
  "{", "}", ":", ".", "&", ";", "::", ",", "=", "let", "str", "i32", "i64",
  "i128", "u32", "u64", "i8", "Text wrapped in quotes", "return", "struct",
  "import", "new", "extern", "_", "local variable or method", "number",
  "fn", "controlled YYERROR", "controlled YYABORT", "controlled YYACCEPT",
  "$accept", "program", "items", "item", "struct", "struct_fields",
  "struct_field", "function", "function_args", "function_arg", "import",
  "identifier", "path", "path_segment", "block_expr", "statements",
  "statement", "let_stmt", "return_stmt", "expr_stmt", "ty", "call_params",
  "none", "expr", "literal_expr", "integer_literal", "string_literal",
  "call_expr", "path_expr", "field_expression", "<<NULL>>" ] ;
...
impl Parser {
  ...
  32 =>  /* let_stmt: "let" identifier ":" ty "=" expr  */
  /* "src/parser.y":225  */
                                                  {
  ...
  48 =>  /* call_params: call_params "," expr  */
  /* "src/parser.y":274  */
                             {
  ...
  61 =>  /* literal_expr: integer_literal  */
  /* "src/parser.y":322  */
                               {
  ...
  62 =>  /* literal_expr: string_literal  */
  /* "src/parser.y":325  */
                  {
    yyval = Value::LiteralExpr(Box::new( yystack.owned_value_at(0)))
 },
  ...
  65 =>  /* string_literal: "Text wrapped in quotes"  */
  /* "src/parser.y":334  */
                         {
  ...
  68 =>  /* field_expression: expr "." identifier  */
  /* "src/parser.y":343  */
                                           {
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yypact_: &'static [i32] = &[     21,   -98,   -21,   -21,    -8,   -21,    14,    95,   -98,   -98,
     -98,   -98,   -98,    34,   -98,   -21,    72,   -98,   -98,   -21,
      70,   -21,    -5,   -98,    17,   -21,    42,     0,   -98,    62,
     -98,   -98,   -21,   118,    16,    73,    75,   -21,   118,   -98,
     118,   118,   -98,   -98,   -98,   -98,   -98,   -98,   -98,   -98,
     -98,    78,   -98,   -98,    76,    83,   118,   -98,   -98,    81,
     -98,   -21,   118,   -21,    88,    64,   -98,   -98,    18,    74,
     -98,   118,    91,    92,   102,   -98,   -21,   -98,   102,   -21,
      31,   -98,    19,   -98,   -98,   -98,   -98,   141,   -98,   -98,
     -98,   -98,   -98,   -98,   -98,   -98,   118,    54,    99,   141,
      32,   102,   -98,    87,   102,   102,   102,   102,   -21,   -98,
     -98,   118,   102,    37,   -98,   141,   -98,    66,    66,    90,
      90,   -98,    98,    47,   -98,   102,   102,   -98,   141,   141 ];
...
const yydefact_: &'static [i32] = &[      0,     3,     0,     0,     0,     0,     0,     2,     4,     6,
       ...
       0,    49,     0,    10,     0,    49,     0,     0,    16,     0,
      19,     9,     0,     0,     0,     0,     0,    49,     0,    11,
       0,     0,    45,    35,    36,    37,    38,    39,    40,    42,
      24,    41,    22,    12,     0,     0,     0,    17,    18,     0,
      43,     0,     0,    49,     0,     0,    23,    14,     0,     0,
      13,    64,     0,     0,     0,    26,     0,    65,     0,     0,
      67,    52,     0,    27,    29,    30,    31,    34,    50,    61,
      62,    53,    55,    56,    63,    44,     0,     0,     0,    33,
       0,    49,    25,     0,     0,     0,     0,     0,     0,    15,
      54,     0,    49,     0,    46,    47,    28,    57,    58,    59,
      60,    68,     0,     0,    66,     0,     0,    51,    48,    32 ];

/* YYPGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yypgoto_: &'static [i32] = &[    -98,   -98,   -98,   105,   -98,   -98,    84,   -98,   -19,    82,
     -98,    -2,   -31,    57,    58,   -98,    24,   -98,   -98,   -98,
     -20,    22,   -97,   -37,   -98,    68,   -98,   -98,   -98,   -98 ];

/* YYDEFGOTO[NTERM-NUM].  */
  #[allow(non_upper_case_globals)]
const yydefgoto_: &'static [i32] = &[      0,     6,     7,     8,     9,    22,    23,    10,    27,    28,
      11,    50,    80,    52,    81,    82,    83,    84,    85,    86,
      53,   113,    30,    87,    88,    89,    90,    91,    92,    93 ];

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
  #[allow(non_upper_case_globals)]
const yytable_: &'static [i32] = &[     13,    14,    51,    16,   114,    31,    34,    51,    36,    51,
      51,    32,    12,    20,    17,   114,    37,    24,    58,    29,
      59,    60,     1,    29,    54,    51,    73,    15,    33,   102,
      24,    51,    37,   103,    37,    29,    64,    97,   101,   112,
      51,    99,    67,    19,    68,   124,    61,    61,   100,     2,
       3,    94,     4,   125,    35,   127,     5,   104,   105,   106,
     107,    29,   110,   125,   115,    51,   108,   117,   118,   119,
     120,   106,   107,    38,    98,   115,   109,    25,   108,    21,
      51,    74,    26,    69,    75,    55,    56,    62,   128,   129,
      63,   122,    76,    61,    74,    65,    69,    69,    71,    95,
      77,    78,   108,    96,    79,    76,   121,    12,    71,    74,
     111,    69,    18,    77,    78,   126,    39,    79,    66,    57,
      12,    71,    70,     2,     3,    40,     4,   116,    77,     0,
       5,    41,    79,    72,   123,    12,    71,    42,    43,    44,
      45,    46,    47,    48,   104,   105,   106,   107,     0,     0,
      49,    12,     0,   108 ];

#[allow(non_upper_case_globals)]
const yycheck_: &'static [i32] = &[      2,     3,    33,     5,   101,    10,    25,    38,     8,    40,
      41,    16,    33,    15,     0,   112,    16,    19,    38,    21,
      40,    41,     1,    25,     8,    56,     8,    35,    11,    10,
      32,    62,    16,    14,    16,    37,    56,    74,     7,     7,
      71,    78,    62,     9,    63,     8,    15,    15,    79,    28,
      29,    71,    31,    16,    12,     8,    35,     3,     4,     5,
       6,    63,     8,    16,   101,    96,    12,   104,   105,   106,
     107,     5,     6,    11,    76,   112,    96,     7,    12,     7,
     111,     7,    12,     9,    10,    12,    11,    11,   125,   126,
       7,   111,    18,    15,     7,    14,     9,     9,    34,     8,
      26,    27,    12,    11,    30,    18,   108,    33,    34,     7,
      11,     9,     7,    26,    27,    17,    32,    30,    61,    37,
      33,    34,    64,    28,    29,     7,    31,   103,    26,    -1,
      35,    13,    30,    65,   112,    33,    34,    19,    20,    21,
...
/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
  #[allow(non_upper_case_globals)]
const yystos_: &'static [i32] = &[      0,     1,    28,    29,    31,    35,    40,    41,    42,    43,
      46,    49,    33,    50,    50,    35,    50,     0,    42,     9,
      50,     7,    44,    45,    50,     7,    12,    47,    48,    50,
      61,    10,    16,    11,    47,    12,     8,    16,    11,    45,
       7,    13,    19,    20,    21,    22,    23,    24,    25,    32,
      50,    51,    52,    59,     8,    12,    11,    48,    59,    59,
      59,    15,    11,     7,    59,    14,    52,    59,    47,     9,
      53,    34,    64,     8,     7,    10,    18,    26,    27,    30,
      51,    53,    54,    55,    56,    57,    58,    62,    63,    64,
      65,    66,    67,    68,    59,     8,    11,    62,    50,    62,
      51,     7,    10,    14,     3,     4,     5,     6,    12,    59,
       8,    11,     7,    60,    61,    62,    55,    62,    62,    62,
      62,    50,    59,    60,     8,    16,    17,     8,    62,    62 ];

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
  #[allow(non_upper_case_globals)]
const yyr1_: &'static [i32] = &[      0,    39,    40,    40,    41,    41,    42,    42,    42,    43,
...
/* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
  #[allow(non_upper_case_globals)]
const yyrline_: &'static [i32] = &[      0,   105,   105,   109,   113,   116,   122,   125,   128,   131,
     134,   137,   142,   146,   149,   152,   155,   158,   164,   167,
     170,   183,   188,   191,   197,   201,   204,   207,   210,   216,
     219,   222,   225,   228,   231,   236,   239,   242,   245,   248,
     251,   254,   257,   260,   263,   266,   270,   272,   274,   280,
     288,   291,   294,   297,   300,   303,   306,   309,   312,   315,
     318,   322,   325,   328,   331,   334,   337,   340,   343 ];
